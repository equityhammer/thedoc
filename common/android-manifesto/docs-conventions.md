...
1. **A new reader can answer "what survives process death today?" by reading the top of this file**, with no SPEC.md spelunking and no grep for `SharedPreferences` across the codebase.
